...
% \flushright {\footnotesize \href{http://nceph.anu.edu.au}{National Centre for Epidemiology \\ and Population Health} \\ Australian National University, \\ \vspace{-0.05in} Canberra, \textsc{ACT} 0200}  
 \flushright {\footnotesize 15 Follett Street \\ Scullin \\ Canberra \\ \textsc{Australia} 2614}  
%\vspace{0.22in}    
\end{minipage}
\hfill     
...
% \marginhead{National Library of Australia Identifier}
% {\vskip 0.6em}
% \noindent 
...
%\item O'Brien LV, Berry HL, Coleman C and \textbf{Hanigan IC}. \emph{Specific pattern of drought associated with worse mental health in rural areas but not in urban areas of Australia}.  Submitted to Global Environmental Change on 14th February 2013. 
