...
\begin{minipage}[t]{2.95in}
 \flushright {\footnotesize \href{http://ivanhanigan.github.io/research.html}{http://ivanhanigan.github.com/research.html} \\ 15 Follett Street Scullin, \\ \vspace{-0.05in} Canberra, \textsc{ACT} 2614}  
...
2013--Present.  Part-time Resarch Data Scientist assisting the Terrestrial \\
\ind Ecosystem Research Network's Australian Supersite Network online data portal and \\
\ind Analytical software developments.
...
\item Wilson LA, Morgan GG, \textbf{Hanigan IC}, Johnston FH, Abu-Rayya H, Broome R, Gaskin C, Jalaludin, B. \emph{The impact of heat on mortality and morbidity in the Greater Metropolitan Sydney Region: A case crossover analysis}.  Accepted Environmental Health 24 October 2013.
