...
\begin{minipage}[t]{2.95in}
 \flushright {\footnotesize \href{http://ivanhanigan.github.io/research.html}{http://ivanhanigan.github.com} \\ 15 Follett Street Scullin, \\ \vspace{-0.05in} Canberra, \textsc{ACT} 2614}  
...
% I have experience in the integration of health, social and environmental data, in particular reconciling health and population data based on incompatible spatial units, and the creation of and linkage with environmental exposure maps.  I am adept in the management of large databases as well as statistical techniques such as Generalised Linear Modelling and Decision Tree analysis.  
...
\item http://researchdata.ands.org.au/weather-exposures-by-statistical-local-area-sla-2001-edition
\item http://researchdata.ands.org.au/monthly-drought-data-for-australia-1890-2008-using-the-hutchinson-drought-index
\end{revnumerate}
...
\begin{revnumerate}
% \item Mr Marco Fahmi, Project Manager (Current Supervisor), Griffith University.  Ph: 0408 139 258, Email: marco.fahmi@gmail.com 
