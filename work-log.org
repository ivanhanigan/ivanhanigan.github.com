...
***** TODO ucrh BME pilot stuff for CC
***** TODO sui_cc complaining about flaws Fountoulakis, netcdf file

***** TODO ucrh neighbour requests find spot for this in datainventory
/home/ivan_hanigan/Dropbox/projects
***** TODO URGENT_ACTION ucrh 0602 UCRH Neighbourhood data inventory overview
      SCHEDULED: <2016-02-02 Tue 15:00>
***** TODO ceraph gantt todo database
***** TODO ucrh start a manuscript
***** TODO ucrh lur_lct qc 2008 and 2006 layers (make map)
***** TODO ucrh ctm csiro cs (TAPM 2007 HD vs shipping_tifs_RB - check extent)
***** TODO ucrh sat_lur qc
***** TODO ucrh study region
***** TODO ceraph super
...
***** TODO personal email ML, MarFa, Tbro, SaBa, BRa and Aspec re ceraph
***** TODO ucrh biosmoke bio_events get FaSa data
      SCHEDULED: <2016-02-02 Tue 16:30>
 from Q drive, inputs to DB, shown as contrib 

***** TODO ucrh files ABS_Boundary_files reconcile with Australian_demographics_ASGC_and_ASGS
