...
***** TODO biodiversity para for paper
Reviewer #2
...
***** TODO ceraph leave request 2
***** TODO hutchinson drought stuff prep (DRT-BOM-GRD)
***** TODO awaptools adspar
***** TODO hutchinson bagdad
***** TODO POA centroids to Hu
**** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
