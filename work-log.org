...
*** 01 Milestones
***** TODO phd 01 Milestones change intention to submit to January
...
***** TODO swish osrd report1 data munging
***** TODO swish osrd report1 get Dave and Steve agreement

*** reproducible research report tools (rrr_tools)
~/tools/ReproducibleResearchPipelineTemplate
**** report RR pipeline template
***** TODO swish rrr push to github
...
**** reports
***** TODO phd 04 suidrt reproducible pipeline
- TODO fix bug with mgcv (is it season (be=cp))?
...
***** TODO phd sections osrd manuscript incorporate
***** TODO phd sections synthesis
***** TODO phd sections general editing
***** TODO swish rrr, datinv and PH observatory chat Rbroo
***** TODO personal maeve gym
