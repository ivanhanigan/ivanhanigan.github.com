...
*** 2016-01-18 Mon 
**** TODO-list 
***** TODO personal respond to ISz and Bke
***** TODO estp wellcometrust 5 papers significance
      SCHEDULED: <2016-01-18 Mon 15:00>
***** TODO ucrh biosmoke bio_events get FaSa data
      SCHEDULED: <2016-01-18 Mon 16:30>
 from Q drive, inputs to DB, shown as contrib 
***** TODO ucrh LCT_LUR rename (on Q, this work always on remote origin, log in file names log)
      SCHEDULED: <2016-01-18 Mon 17:00>
***** TODO ucrh LUR for LCT check out with new name, and in again with revised data
***** TODO ucrh files CTM CSIRO sync metadata, checkout of datinv_ap, work on local
...
***** TODO review aihw air pollution paper
