...
***** TODO phd datinv mod to Intellectualright
    ...
    Field('special_conditions', 'text', comment = 'Any restrictions to be placed on the access or use, especially the timeframe if limited.'),
...
***** TODO phd datinv add function to extract the report
