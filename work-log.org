...
**** TODO-list 
***** TODO ucrh timesheet
***** TODO rws nsw farm resfor each capital sub domain indices
****** TODO rws nsw farm res  + ensure s-sheet up to date
****** TODO rws nsw farm res  + check sub indices are stndised to 0-10?  fincap are 1-7!
***** TODO email jpatz
***** TODO email tim decra
***** TODO ucrh writet letter to  Fabiana
***** TODO rws chrisambrey
***** TODO decra
****** TODO shopping list
****** TODO tee up international
- jpatz
- j rosethal
- m braur
- sarah Hendin
- ksmith
***** TODO ceraph thur presentation
***** TODO rws nsw farm resdrought report meets s-sheet?  input the new subheadings
***** TODO rws nsw farm rescreate a summary graphic eg horiz barplot for one of the drt prep/schemes usefuleness
***** TODO ucrh manuscript inputs ala bookdown/manuscript template/presentation
***** TODO ewedb drought think about aekos vs KNB? 
also, don't publish NSW DPI data... at all or till after paper? 
***** TODO ceraph less identifiable hosp data to rstudio
***** TODO swish dmp flow chart to spreadsheet
      SCHEDULED: <2016-11-13 Sun 13:00>
***** TODO swish update EML package, look at onboarding
***** TODO Spatiotemp mlm merge mgimmond bookdown with jekyll and presentation style
***** TODO personal backups - Pictures/music
