...
*** 2016-02-28 Sun 
**** TODO-list 
***** TODO ucrh swish-dmp as book/website
***** TODO ucrh biomass db extract
***** TODO ucrh eml2 test (biomass first, then ecosocial tipping)
***** TODO ucrh install matlab local
***** TODO ucrh install BME lib
***** TODO ceraph swish-dmp LuSm edits into the main org
      SCHEDULED: <2016-02-27 Sat 11:45>

***** TODO ceraph drought, bushfires and election study (database demo public)
***** TODO ceraph contracts etc organise PDS meetup

***** TODO peronal Filing
\\mhsdata.anu.edu.au\mhs\workgroups\rsph\nceph\Projects\Environmental_Health\Climate Change and Health\Thermal stress\2 Analysis\CauseSpecific

\\mhsdata.anu.edu.au\mhs\workgroups\rsph\nceph\Projects\Environmental_Health\Archive\Climate_Data\Projects\Air Pollution\ACT Bushfire Study\Fire Images

\\mhsdata.anu.edu.au\mhs\workgroups\rsph\nceph\Projects\Health Forecasting Project
