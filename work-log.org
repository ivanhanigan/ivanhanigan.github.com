...
***** TODO ceraph RWS EWE report headings
***** TODO ceraph sync downloads from foo to Q drive
***** TODO ceraph ML workshop: request RRV from Mlind
***** TODO ceraph RWS EWE paper ideas
***** TODO ceraph RWS farmer report graphs
***** TODO swish ANUlib Pne DC serve
***** TODO ceraph talk to RaDa as performance
- PDS/PEAS
***** TODO ucrh workflow and protocol
***** TODO ucrh abstract
***** TODO ceraph RRv multi-level model and data set
***** TODO ceraph read neighbourhoods and plos
***** TODO ceraph RWS cloud storage plan migration
***** TODO ceraph RWS update indexorg with R codes from scripts
...
***** TODO obs version control idea to ViLe
***** TODO Toco indirect rates log the email
      SCHEDULED: <2016-07-27 Wed 10:30>

---------- Forwarded message ----------
From: Tom.Cochrane <Tom.Cochrane@canberra.edu.au>
Date: Thu, Jul 21, 2016 at 10:40 AM
Subject: Importance of scale and Mendeley
...
The data we need for the importance of scale analyses are, for each level (SA3, SA2, SA1):

- For years2010, 2011 and 2012
- SEIFA scores
  + just  2 Disadvantage ones (IRSD and IRSAD)
  + all 5 (or 4, exclude rural one?)
  + continuous works as we are basically relying on their rank order
- ASGS code is needed for linking, make sure it is consistent across data sources (5 digit vs 9 digit codes)
- Census resident Population by age and sex 
- ASRates for the standard are applied to the age structure for each study pop (small area)
  + of ACT for same period, used as the standard in indirect method
  + proportional hazards
  + rate shrinkage
    * spatial smoother
    * weight by the inverse of the variance
- Number of events
  + one episode per month
  + four episodes per year
- ICD groups older than 18 years
  - CVD
  - all four diag groups


ASR - age-standardised rate - the SPHO used the European standard population standardised rate but we will have to adapt for our local needs, probably indirectly standardised rate basd on those for the ACT


I've attached a copy of the Excel file that I used to do the original Concentration Index calculations from the Stoke on Trent mortality data. This was adapted from the example provided in the Scottish Public Health Observatory paper (Monoz-Arroyo ref. from our Report to ACT Health). When you open it, the file will ask you if you want to update - just click no to this as the link will no longer exist.


I also have Excel templates for the calculation of population attributable risk and fraction, and slope and relative index of inequality, but basically they all say more or less the same thing. Also attached is a more detailed account of the background to the Concentration Index, for your edification or to put you to sleep  (as it did me)!


I have downloaded Mendeley and have a starting idea of how to create and populate folders. How do I set up a Group (or access one you have already set up) so that I can start sending relevant stuff to you and Vince?
...
***** TODO ceraph RWS TODO-list
- DONE GNaf method notes from Fran to Ja
- DONE remind User guide edits to ja
- TODO Metadata
  + SPSS labels
- Drought data
  + AWAP stuff
- Drought report
  + sideways barchart codes
  + org multi codes and report outputs to html and into word doc
***** TODO ucrh project exposures script
***** TODO wa pollution stations
WA, D. of E. and C. (2009). Western Australia Air Monitoring Report. Retrieved from http://www.scew.gov.au/system/files/resources/0389f889-e0a7-4ad4-7dc9-51d20958f481/files/aaq-mntrpt-2008-wa-report-final.pdf
/home/ivan_hanigan/references/WA - 2005.pdf
***** TODO personal cv include invited talk to ANDS 23things

---------- Forwarded message ----------
From: Karen Visser <karen.visser@ands.org.au>
Date: Wed, Jun 29, 2016 at 3:59 PM
Subject: 23T Crash course: follow up links
To: Ines Hessler <ines.hessler@ands.org.au>, Anne Lahey <anne.lahey@anu.edu.au>


Hi,

Thanks for your interest in the 23T Crash Course on Monday - it was great to have so many people starting out, and to hear the rich discussions.

Thank you to the ANU Library for hosting the session, and also to Sue Fyfe (Dept of Environment) and Ivan Hanigan (UC) for sharing their data stories with us over the break.

For those just beginning 23T here are some useful links:

    bookmark the 23T homepage
    sign up for MeetUp (online discussion forum if you want to contribute or see other people's contributions)
    subscribe to 23T fortnightly newsletter (until Sept this year)

For everyone

The next 23T community webinar will feature "people behind the data behind 23T" - a great way to hear stories of how people have changed careers or tweaked their jobs to become part of the research data community:  Register for all with one registration

    Tue, Aug 2, 2016 12:30 PM - 1:30 PM AEST
    Tue, Sep 6, 2016 12:30 PM - 1:30 PM AEST
    Tue, Oct 18, 2016 12:30 PM - 1:30 PM AEDT 

Great to see you all interested in making more research data more visible within our research communities.

Remember you don't need to all 23 Things - cherry pick, pick'n'mix your levels and enjoy!

Cheers
Ines, Rowan, Susannah and Karen 


-- 
Karen Visser
Program Leader,  Skills Policy Resources | Australian National Data Service 

T: +612 6125 7121  | M: +61 478 401 229  |  E: karen.visser@ands.org.au 
W: ands.org.au  |  YouTube: https://www.youtube.com/user/andsdata  | Tw: #andsdata 

Australian National Data Service  ||   The Australian National University
101 Liversidge Street     Acton ACT 2601    Australia
Postal address: ANDS Office, Monash University, F610, PO Box 197, Caulfield East VIC 3145

Please consider the environment before printing this e-mail
***** TODO biosmoke get best script from fasa
***** TODO biosmoke add metadata and review manuscript
***** TODO figure out spot for errant mb file
/home/ivan_hanigan/projects_environment_general_local/Study_Regions/greater_syd_metro_reg_2006/data_derived
MB2011_NSW.csv

***** TODO ceraph absdata move seifa 2006 old
/home/ivan_hanigan/projects_environment_general_local/ABS_data/ABS_SEIFA

***** TODO ucrh move inside temp on USB drive OR DELETE
...
**** TODO-list 
***** DONE datinv backups
***** TODO RWS beamer pres
***** TODO RWS barplots
***** TODO RWS bookdown/emacs
***** TODO car postdoc
***** TODO Obs report word
***** TODO ucrh project exposures to Q drive, then gateway
***** TODO UCRH LCTunnel chunk
***** TODO swish-dmp add checklist for version release
***** TODO awaptools to BraEv
**** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
