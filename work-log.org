...
***** TODO ceraph ideas for RRR session with Ro
- start with a) geeks and repetitive tasks and then b) horror stories?  or vice verca
***** TODO ucrh aphea protocol with farhad
***** TODO ceraph RWS update indexorg with R codes from scripts
***** TODO ceraph RWS cloud storage plan migration
***** TODO ceraph RWS cloudstor, share cleaned with JS
***** TODO ucrh sydney inventory
      SCHEDULED: <2016-03-09 Wed 12:00>
***** TODO personal planning gantt and storyboard
      SCHEDULED: <2016-03-07 Mon 13:30>
***** TODO biosmoke farhad contribution finalise, check with Gwil re web2py download

***** TODO EML do review of vignette
**** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
