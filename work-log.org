...
***** TODO ceraph construct core model and walk/SEIFA/food
***** TODO ceraph talk to RaDa as per
- PDS
- CAR abstract
...
***** TODO ceraph transcribe the notes from obs meeting (when is next?)
***** TODO ceraph read neighbourhoods and plos
***** TODO ceraph RWS get emails related to structure of reports
