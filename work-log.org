...
***** TODO suidrtnsw suidrtnsw reports re: reproducible pipeline fixing (mgcv?)
      SCHEDULED: <2015-12-03 Thu 17:00>
- TODO fix bug with mgcv (is it season (be=cp))?
...
** 1Air pollution from bushfires and duststorms
*** Air pollution from bushfires and duststorms BiosmokeValidatedEvents DB
...
** 1Air pollution monitoring and modelling: Neighbourhood exposures
...
** 1Mortality and morbidity effects from biomass smoke
** Biomass Smoke and Human Health
*** Darwin vegetation and smoke studies
*** launceston
*** biosmoke_mort
*** heat_health_warning_system_sydney
** 1Extreme weather events
** EHF
** 1Mortality and morbidity effects from EWE
** SydneyGMR and heat
** 1Infectious diseases and local habitat
** RRV and waterways
** Gastroenteritis and weather
** 1Eco-social tipping points
...
** 1Reproducible research pipelines
** SWISH
...
***** TODO swish osrd report1 manuscript
...
***** TODO ucrh 0605 UCRH General Contract management re: email gmo with timelines for work via Jan, casual contract
      SCHEDULED: <2015-12-05 Sat 16:00>
***** TODO biosmoke bio_events get FaSa data from Q drive, inputs to DB, shown as contrib 
      SCHEDULED: <2015-12-05 Sat 14:00>
