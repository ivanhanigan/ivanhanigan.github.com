...
***** TODO ceraph data requests
***** TODO ceraph town centres
***** TODO ceraph ML note about the way to do linear versus logistic from Yoh
***** TODO ceraph ML note about the way the variance for the group level is accessed
- variance explained by the group
                 
***** TODO ceraph ML note about borrowing information from the other groups
***** TODO ceraph note gordon and stillwell
***** TODO ceraph ML slides and refs
- begin tute codes and slides
- Refs
...
***** TODO ceraph esos act: walking and walkability
***** TODO ceraph RWS lit review

\cite{Nelson2005}\cite{Nelson2004} \cite{Kokic2006a}\cite{Kokic2006}\cite{Edwards2014}

Dataset: ABARE’s 2001-02 natural resource management survey of Australian broadacre and dairy farms. 
Variables: Socioeconomic, demographic, awareness of degradation and the adoption of sustainable farming practices. 
Papers: Nelson, R., Kokic, P., Elliston, L., & King, J. (2005). Structural adjustment. Australian Commodities, 12(1), 171–179. 

Dataset: ABARE’s annual farm surveys 1992-93 and 2001-02 
Variables: Indicators of five types of capital on which rural livelihoods depend: human, social, natural, physical, financial.
Papers: 
1) Nelson, R., Alexander, F., Elliston, L., & Blias, A. (2004). Natural Resource Management. abare eReport 04.7.

Dataset: ABARE’s Australian agricultural and grazing industries survey (AAGIS) of broadacre farmers from 1988-89 to 2003-04. Linked to moisture availability index data obtained from the Queensland Department of Primary Industries.
Variables: Indicators of five types of capital on which rural livelihoods depend: human, social, natural, physical, financial.
Papers: 
1) Kokic, P., Davidson, A., & Boero Rodriguez, V. (2006). Australia’s Grains Industry: Factors Influencing Productivity Growth: ABARE Research Report. Canberra, Australia: ABARE Research Report 06.22 prepared for the Grains Research and Development Corporation.
2) Kokic, P. N., Davidson, A., & Boero Rodrigez, V. (2006). Australia’s grains industry: Factors influencing productivity growth. Australian Commodities, 13(4), 705–712.

Dataset: The 2007 Rural and Regional Families Survey (RRFS).
Variables: Drought, farm productivity, mental health.
Papers: Edwards, B., Gray, M., & Hunter, B. (2014). The Impact of Drought on Mental Health in Rural and Regional Australia. Social Indicators Research, 177–194. doi:10.1007/s11205-014-0638-2
***** TODO ceraph ML workshop: test rstanarm
...
#+end_src
***** TODO ceraph ML workshop: general health survey walking/walkability of suburbs
***** TODO ceraph cvd-walk-food workplan, setup relative paths
***** TODO ceraph capture new cat 1 grant bodies into a project doc
***** TODO ucrh BME satlur wa and mbs
***** TODO ceraph ML workshop: request RRV from Mlind
      SCHEDULED: <2016-05-08 Sun>
- showcase GIS power of R
***** TODO ceraph RWS user guide
***** TODO ceraph RWS summary of datasets
***** TODO ucrh BME build perth data
***** TODO ucrh biosmoke get Gmo comments off email and save
***** TODO ucrh set up a run with 2011 soft data
***** TODO ceraph software man doc
***** TODO ceraph observatory SOW 
***** TODO ucrh noise send dat inve and workplan to team
...
***** TODO ucrh biosmoke BMC note to co-authors
      SCHEDULED: <2016-05-08 Sun>

***** TODO ucrh 0605 UCRH CAR postdoc applications
      SCHEDULED: <2016-05-08 Sun>
