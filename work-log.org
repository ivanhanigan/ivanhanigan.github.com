...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2018-11-30 Fri, data, 50
#+end_src
***** DONE jfsp smoke flag
***** DONE datinv meet cass
***** DONE datinv send cass proc man
***** DONE sure infor for farhad
***** DONE meet jfsp
***** DONE jfsp meet
      SCHEDULED: <2018-11-30 Fri 13:00>
***** DONE car webinar
      SCHEDULED: <2018-11-30 Fri 12:00>
***** DONE mow the lawn
***** DONE send to grant
***** DONE canberra launch lancet countdown
      SCHEDULED: <2018-11-30 Fri 15:00>
***** DONE aptema mort EI email co-authors
*** 2018-12-05 Wed 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2018-12-05 Wed, ehi, 50
#+end_src
***** DONE ehi meet geoff
***** DONE hia melb schedule
***** DONE biosmoke 
*** 2018-12-06 Thu 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2018-12-06 Thu, hia, 50
#+end_src
***** DONE aptema meet
***** DONE aptema pm2.5 lur send to sure
***** DONE aptema pm2.5 and no2 spatiotemporal
***** DONE usyd ap&d
***** DONE fire journal revise proofs send

*** 2018-12-07 Fri 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2018-12-07 Fri, hia, 50
#+end_src
***** DONE daily pm2.5 time plot for sydney and canberra
***** DONE personal rebel sport and headphones for jogging
***** DONE CVRN meeting
      SCHEDULED: <2018-12-07 Fri 10:00>
***** DONE R intro on coesra, include ross river motivating (with spatial plus jitter)
***** DONE intersect spaces decomission
***** DONE ml-smoke processing with ahi flag correction, add landcover and dem, as a report
***** DONE ML smokeplume look at nc NA vs 0...
***** DONE ML meeting
      SCHEDULED: <2018-12-07 Fri 13:00>
***** DONE noise meet martine
      SCHEDULED: <2018-12-07 Fri 14:30>
***** DONE ehi to meet re coesra and martine, neil hime@nsw health
***** DONE hia planning and slides
***** DONE jfsp elevation,,, ask luke?
***** DONE aptema mort revise for epidemiology or lancet or what? see what Geoff says
*** 2018-12-19 Wed 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2018-12-19 Wed, hia, 50
#+end_src
***** DONE josh nsw epa group query
***** DONE ucrh concur aquit
***** DONE consultancy $ summary check data FOR NOVEMBER
***** DONE ml smoke 1) landcover velox 2) if fail just go without
***** DONE data sharing with affiliates to dmp doc
***** DONE training packages script to hoang
***** DONE audit send gantt to cassandra for comment, what about add countdown? and noise components?
***** DONE meet cassandra
***** DONE personal ladders, dog food, tarp (5x3m)
***** DONE nea graduation
      SCHEDULED: <2018-12-19 Wed 12:00>
***** DONE ml smoke overleaf 
*** 2018-12-20 Thu 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2018-12-20 Thu, cares, 50
#+end_src
***** DONE CARES stff
***** DONE COESRA UC stff email hoang
***** DONE email grant
***** DONE COESRA UC stff
***** DONE EnRICH UC Stff
***** DONE climate council 1 pager 1) email paul and hilary re referees 2) update CV
***** DONE get review from Ben Ek
*** 2019-01-04 Fri 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-01-04 Fri, personal, 50
#+end_src
***** TODO jadehawk backups prior to updates
****** DONE daily.sh
****** DONE paused canberra@cloudstor YES
****** DONE paused dropbox YES
****** DONE apt-getupdate and upgrade as is
****** DONE data_inventory CSV and postgres
****** DONE other postgres? (postgis_hanigan and ewedb_staging) copy to projects_archive_offline (on PC)
****** DONE make sure the pg_restore works on to hack FAIL, NEEDS UPGRADE? TRY CAR SWSH
****** DONE use jadehawk, restore postgis_han (from jadehawk as is small), 
sudo su
su - postgres
psql
alter database postgis_hanigan rename to postgis_hanigan2;
create database postgis_hanigan with encoding ='UTF8' owner = ivan_hanigan connection limit =-1;
\q and exit to ivan (or have two terminals)
pg_restore -h localhost -p 5432 -U postgres -d postgis_hanigan -v "/home/ivan_hanigan/projects_archive/postgres_backups/postgis_hanigan_backup_2019-01-04-1602.backup"
****** DONE use coesra@sydney to upgrade CAR postgres VM
*** 2019-01-07 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-01-07 Mon, aptema, 50
#+end_src
***** DONE data audit plan and new datasets to add
****** DONE reply to questions from 2018-12-14 Fri

- Noise data and weather - do you have the creators/contacts?
  + Noise data for Melbourne 2011 is creator = Ben Hinze, see https://www.dropbox.com/s/ouu8d91r6kl1jb4/WSP%20Report%20-%20Noise%20Exposure%20Melbourne%20Feb%202014%20%28002%29.pdf?dl=0
  + Other noise data in Australia come from Prof Lex Brown ( lex.brown@griffith.edu.au) and Marc Buret Senior Applied Scientist - Noise & Vibration Environmental Solutions VIC EPA
  + Weather: there are several Datasets within the Australian Weather project
    * AWAP
    * BOM monitors
    * ANU Fenner
- SEIFA - when you wanted them split into components were you meaning into the four indexes?
  + Not unless the files are provided like that.
  + At the moment I have tried using the following which works Projects>ABS_data>Datasets>ABS_SEIFA>Entities>SEIFA_1986, ABS_SEIFA_2011_SA2, ABS_SEIFA_2006_CCD etc	
- NDVI - these are the maps from BoM or derived from BoM? Contact?
  + NDVI Downloaded preprocessed data at 5x5km resolution from http://www.bom.gov.au/jsp/awap/ndvi/index.jsp BoM processing described at: http://www.bom.gov.au/climate/austmaps/about-ndvi-maps.shtml
  + Contact is me
- Walkability and tree data - I had a look at the linked page and AURIN but could not find tree data as mentioned (only a few local datasets). The walkability data - is that just footpath maps from PSMA?
  + Thanks re trees just a few datasets, can you suggest how we might list these in the To Get list?
  + re Footpaths yes if PSMA have them (I don't know).  The other ones I heard of are OpenStreetMap and maybe Pitney Bowes Geoscape

- Re Joy said she doesn't think there has been much progress on the Health outcome audit status. She's suggested to Jane and myself that I could do this as part of the data audit - how do you feel about it?
  + See how it goes, if the data audit process works well by asking about specific paper projects then we can do that 
****** DONE data audit dem notes
list of ga products
...
****** DONE Birjan
***** DONE SURE project exposures extract new PM, NO2, Drt
****** DONE no2 bme extract and compare
****** DONE pm25 sat extract and compare
****** DONE QC for aptema mort
****** DONE SURE drought extract
******* DONE drt-45up qc with 2) raw awap grids
***** DONE reply to grant re areal
***** DONE ctm check monthly orig data from RB (not there for PM2.5)
*** 2019-01-08 Tue 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-01-08 Tue, leave, 50
#+end_src
***** DONE aptema mort etc next steps
***** DONE singapore shapefiles
***** DONE data audit plan and new datasets to add
***** DONE EHindicators read HEADLAMP books
***** DONE LFS data request that farhad, josh, nico, fay, etc don't share from that location
***** DONE josh nmmaps (dlnm, season, my own, yuming/adrian)
*** 2019-01-10 Thu 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-01-10 Thu, mlsmoke, 50
#+end_src
***** DONE car review postdoc
***** DONE aptema mort etc next steps, review
*** 2019-01-11 Fri 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-01-11 Fri, aptema, 50
#+end_src
***** DONE SURE workspace crap
***** DONE aptema mort etc next steps revise 
*** 2019-01-17 Thu 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-01-17 Thu, aptema, 50
#+end_src
***** DONE aptema mort share co-authors
***** DONE ml smoke data prep / scan all NT dates
*** 2019-02-06 Wed 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-02-06 Wed, ehindicators, 50
#+end_src
***** DONE aptema mort resubmit
***** DONE EH indicators report and presentation set up
*** 2019-02-08 Fri 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-02-08 Fri, ehindicators, 50
#+end_src
***** DONE smoke plume stuff
***** DONE caps cohort LUR comparison
Hi Christine, 

These questions seem to request more work with
modelling, which will be challenging with available timeframes.

My quick read through:
- It is only Rev2 with major comments, and they are asking for more
  comparison of the models in general instead of the predicted values
  at cohort locations
- Rev 2 question 2 is long and critical...
  + Quote example: "LUR is easier to apply but it doesn't necessarily mean that more
    complex methods don't have to be tested for the epidemiological
    analyses."
  + Quote example: "The choice of the modeling strategy for estimating
    the air pollution exposure for the cohort studies should be based
    not only on the availability of the data and feasibility, but also
    on the predictive performance of different models in similar
    settings. Thus, the careful selection of the location of the
    samplers for the cohort study is most likely to be the reason why
    the LUR model gave similar estimates at the cohort locations when
    compared to ..."
  + This is tricky. The reviewer seems to be asking us to abandon the
    question "is our cohort sample/study pop estimated well by LUR
    compared to other models" and only focus on model comparisons
    generally. I think that would be a shame. We just need to
    demonstrate that the models perform similarly and therefore the
    simpler/faster/more-feasible method can be justified.

Rev 2 q 4:
- Why to present the maps of only one model if there is no comparison
  to the results of the other models as suggested by Reviewer #3 and
  the comparisons are done only at cohort locations? Furthermore, it
  is still not clear to me how the maps were produced: "The maps were
  produced using R software version 3.2.1". Was it a spatial
  interpolation of the estimates obtained at the cohort locations?
  Please add details.
- The maps do look like they were made with ArcGIS. The surface
  (raster) of predicted pixels may have been produced using R?
- BTW the raster in Fig 3 Insets seem to be at 250m x 250m resolution
  whereas the quote begins "concentrations across the study area were
  produced using a 500 x 500 m grid"



***** DONE eh indicators countdown, IUCN red list, system overview template, 5 caps
***** DONE EH indicators sent
*** 2019-02-18 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-02-18 Mon, aptema, 50
#+end_src
***** DONE marg roadshow contacts
***** DONE ceraph
***** DONE noise with tim
***** DONE personal dentist
***** DONE drt kim email
...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-02-19 Tue, hhsi, 50
#+end_src
***** DONE cares workplan review 2018 due 1st feb

Can you please provide a few sentences or dot points to me by the 1st Feb so I can report this information to the next Executive committee meeting.
***** DONE Coesra data management
***** DONE noise tim draft 
***** DONE aptema parkinsons 
***** DONE cares meeting prep
***** DONE aptema mort media
*** 2019-02-22 Fri 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-02-22 Fri, cares,ml,ehi, 50
#+end_src
***** DONE cares meeting
      SCHEDULED: <2019-02-22 Fri 11:00>
***** DONE personal call shane
***** DONE EH indicators agenda, add data item and send
***** DONE personal grrls
      SCHEDULED: <2019-02-22 Fri 14:45>
***** DONE aptema mort media
***** DONE ml smoke data prep
*** 2019-02-24 Sun 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-02-24 Sun, plan, 50
#+end_src
***** DONE hia generic workflow (is it in walkairhealth)? yes - flowgraph
***** DONE hia sharing melb pm25 on vicepa@coesra, same(ish) on private with ivan@sydney
*** 2019-02-25 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-02-25 Mon, ehi, 50
#+end_src
***** DONE ehi presentations
*** 2019-02-26 Tue
***** DONE car roadshow
***** DONE car meet emily banks
*** 2019-02-27 Wed 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-02-27 Wed, hia, 50
#+end_src
***** DONE hia planning with geoff
***** DONE cvrn meet Daniel
- send metadata
- send instrucitons coesra
- send swirl and intro to R/GIS gimmond
*** 2019-03-01 Fri 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-01 Fri, car, 50
#+end_src
***** DONE car data audit with cassandra
***** DONE ml smoke plume rmarkdown, and paper
***** DONE supervise heather awap poa
***** DONE vet compass email joy
***** DONE exposim to luke
*** 2019-03-05 Tue 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-05 Tue, swish, 50
#+end_src
***** TODO backups on cloudstor usyd/Qdrive
- env gen/ study regions/ exposim/ dat prov/ was dbf having trouble, switch off sync selective
- found coesra missing from ucrh pc168, do later? it doesn't want to sync to coesra ivan/syd folder is switched off... is that affecting the others?
- the flood 2017 stuff is missing from ..., but it might be better in projects/ or Dropbox?
- decide if I can delete old 2018-06-20 folder from pc168
***** DONE car data management with geoff
***** TODO datinv
****** DONE add cadastral
****** DONE add streetpro
****** DONE add frac cover
...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-06 Wed, aptema, 50
#+end_src
***** DONE ucrh backups check (done, check again in 2hours)
***** DONE datinv push to coesra car and then private with coesra (DONE), CAR dropbox (done), CAR shared (done) and cvrn (DONE), 
***** DONE datinv UCRH cloudstor
***** DONE github maps to tom
***** DONE noise map 
***** DONE aptema western sydney
***** DONE car travel next thu/fri 
***** DONE vetcompass works on eda and heat
*** 2019-03-08 Fri 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-08 Fri, smoke, 50
#+end_src
***** DONE aptema add betas in standard interaction, check frailty on sla, send to farhad
***** DONE hia download vensim
***** DONE awap heather 
*** 2019-03-12 Tue 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-12 Tue, ehi, 50
#+end_src
***** DONE adam steer invite
***** DONE HGSG invoice templates
***** DONE jane pres
***** DONE exposim data report as bookdown or single html/word file
***** DONE cassandra email re final report
***** DONE meet geoff
      SCHEDULED: <2019-03-12 Tue 12:00>
***** DONE meet adam
      SCHEDULED: <2019-03-12 Tue 14:00>
***** DONE meet RSO re nhmrc
*** 2019-03-13 Wed 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-13 Wed, various, 50
#+end_src
***** DONE steve vanderhoorn's email about land use data to geoff
***** DONE steve email re cassandra list and my plan to do coded workflow to autoupdate yearly, starting with 2016/17
***** DONE cloudstor to rapid review students
****** notes
Edward Jegasothy
...
We’ve got three students enrolled in our capstone for the rapid review.

 

Are you happy to be main contact and get the ball rolling with an email to the students?
...
-          Ask them to introduce themselves: where they are based, academic/professional background, interests, skills to help tailor the project

o   Have they done env health / adv epi?

-          Organise a zoom meeting in next week or so

 

Ed

From: Adriana Newman On Behalf Of MPH Admin Officer
Sent: Tuesday, 12 March 2019 4:03 PM
To: Edward Jegasothy <edward.jegasothy@sydney.edu.au>
Subject: Capstone project 14 - student details
...
This is to confirm that the following students are enrolled in your Capstone project - Rapid review to prioritise environmental hazards and health outcomes.

 

480087106

CAMILLO JEREMY ARCHIBALD LAMANNA

clam5986@uni.sydney.edu.au

480095961

HANCHEN WANG

hwan4574@uni.sydney.edu.au

480494304

HIU WAI TSE

htse7470@uni.sydney.edu.au

 

Tim Driscoll advised the students that topic leaders will be in touch by the end of this week to discuss the project requirements.

 

Please let us know if you have any issues contacting the students.
****** references
****** master_spreadsheet
****** staging_area
******* from_camillo
...
****** study_protocol
****** README
***** DONE meet tony capon, advisor
***** DONE personal radha cv
***** DONE cloudstor canberra to usyd (after first update ucrh)
*** 2019-03-14 Thu 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-14 Thu, visitsydney, 50
#+end_src
***** DONE daniel/melody cpc
      SCHEDULED: <2019-03-14 Thu 11:00>
***** DONE ying lancet countdown
***** DONE car exposure workshop
*** 2019-03-19 Tue 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-19 Tue, ml smoke, 50
#+end_src
***** DONE pubhlth capstone emails
***** DONE ml smoke data prep
****** DONE new NT case study
****** DONE ml smoke processing appendix
****** DONE meeting
***** DONE edokpolo manuscript
***** DONE bike tyre
***** DONE colin butler tertiary ref
***** DONE datinv to melody and daniel via coesra and datascience training
****** DONE cvrn dataset list to Melody
***** DONE email jane has any mortality and air cohort in perth, or australia
***** DONE UCRH cloudstor data sync and backup to external HDD
***** DONE receipts scan last trip
...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-22 Fri, cares, 50
#+end_src
***** DONE Capstone students
***** DONE CARES prep and meet
***** DONE ML smoke meet
***** DONE grant money to Rachel (based on Gavin)
***** DONE backups
*** 2019-03-25 Mon 
**** TODO-list 
***** TODO 
**** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-25 Mon, hia, 50
#+end_src
***** DONE backups
- DONE remove half backup on ritmo2
- DONE rename owncloud on jadehawk to owncloud_canberra
- DONE rename on ritmo2
- DONE rename on HDD1
- DONE run daily.sh backup on HHD1, this should do very little
- DONE run weekly.sh on HDD1, = 20190325. this is the best March 2019 backup (Ritmo2 22'march'19 is actually old cupboard in UC version, rename Ritmo2 to reflect cupboard at UC status)
- DONE run daily.sh on ritmo2 (ONLY IVAN_HANIGAN FOLDER, NOT RESEARCH DATA ETC), this will probably do a hell of a lot
- DONE Check ResearchData and EnvironmentGeneral are both up to date on HDD1
- DONE AT THIS POINT I AM UP TO DATE ON BOTH AND POISED TO CREATE NEW OWNCLOUD (AT SYDNEY)
- DONE go to coesra@sydney and sync cloudstor
- DONE go to ucrh and sync cloudstor (note that this is selective sync due to space on pc168)
- DONE AT THIS POINT CLOUDSTOR@sydney IS UP TO DATE ON THE CLOUD AND AT UCRH (although UCRH is selective sync)
- DONE CHECK CLOUDSTOR@CANBERRA IS UP TO DATE ON CLOUD (coesra, and cloudstor), then turn sync off and never on again
- DONE remove sync for @canberra from owncloud on jadehawk
- DONE add sync to new owncloud@sydney folder, selective sync to just set up new projects_transfers
  + https://cloudstor.aarnet.edu.au
  + https://support.aarnet.edu.au/hc/en-us/articles/208932117-How-to-sign-in-using-ownCloud-sync-client-
- DONE test sync from jadehawk to cloudstor syd and coesra syd
- DONE run daily.sh backup on HDD1, this should do very little
- DONE move owncloud_canberra from HDD1 ivan_ha to top level folder so not in backups
- DONE run daily.sh on ritmo2, this should do very little
- DONE move owncloud_canberra from Ritmo2 ivan_ha to top level so not in backups
- DONE AT THIS POINT I HAVE OWNCLOUD CANBERRA AS AT JADEHAWK RETIRE ON JH, HDD1 AND RIT2
- DONE delete owncloud_canberra from jadehawk, so not in backups
- DONE do backup daily.sh to HDD1
***** DONE hia noise methods
***** DONE personal trip to mitchell plumbing
***** DONE personal groceries
***** DONE personal pick up maeve, go to tennis

***** DONE coesra firefox warning to Yi

*** 2019-03-26 Tue 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-26 Tue, hia, 50
#+end_src
***** DONE recruit adam
***** DONE meet geoff
      SCHEDULED: <2019-03-26 Tue 11:00>
***** DONE follow up with jal
***** DONE personal music notation
*** 2019-03-27 Wed 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-03-27 Wed, hia, 50
#+end_src
***** DONE cassandra contract
***** DONE data request from arul


On Fri, Mar 22, 2019 at 10:26 PM Geoffrey Morgan <geoffrey.morgan@sydney.edu.au> wrote:

    Ivan

    See below email from Arul Earnest, a friend and colleague from Monash, who is requesting data on annual average pm, no2 and o3 for Vic.  Perhaps the satellite lur’s for pm2.5 and no2 and the monitor data for o3 (Melbourne only)would 
    Suitable.  I bane ccd arul above. 

    Let me know if you need more info or contact arul direct. 
...
>     From: Arul Earnest <arul.earnest@monash.edu>
>     Date: 14 March 2019 at 3:41:33 pm AEDT
>     To: Geoffrey Morgan <geoffrey.morgan@sydney.edu.au>
>     Subject: Re: Air pollution and prostate cancer...
>
>     Sorry Geoff, should be just Victoria.
>     cheers
...
>
>     Unit Coordinator, MPH5270
>
>     Author: Essentials of a Successful Biostatistical Collaboration. https://www.crcpress.com/Essentials-of-a-Successful-Biostatistical-Collaboration/Earnest/p/book/9781482226980
>
>
>     Department of Epidemiology and Preventive Medicine
>     School of Public Health and Preventive Medicine
>     cid:image001.png@01CDB90E.CE4BD790
>      
>
>     Monash University
>     Room 415, Level 4,
...
>     Melbourne VIC 3004
>      
>     Phone: +61 3 9903  0112
>
>     Fax: +61 3 9903  0556
>     Email: arul.earnest@monash.edu
>
>
>
...
>
>
>     I acknowledge the Traditional Owners and Custodians of the lands on which I live and work and pay my respect to Elders past, present and future.
>
>
>     On Thu, 14 Mar 2019 at 15:15, Geoffrey Morgan <geoffrey.morgan@sydney.edu.au> wrote:
>
>         Is if for Vic or all Australia. G
>
>         Sent from my iPhone
>
>         On 14 Mar 2019, at 2:48 pm, Arul Earnest <arul.earnest@monash.edu> wrote:
>
>>         Hi Geoff,
>>         I think we can have annual data (from 1982 or any start year you have) by postal code as that is the data we have..
>>         Those 3 pollutants will be great. There are other factors we can throw in (e.g. SEIFA, remoteness, etc).
>>         Thanks
>>         arul
>>
>>         Arul Earnest (PhD, MSc, DLSHTM, BSocSc Hons) 
...
>>
>>
>>         On Thu, 14 Mar 2019 at 13:16, Geoffrey Morgan <geoffrey.morgan@sydney.edu.au> wrote:
>>
>>             Arul
>>
>>             Please let me know the spatial extent of the study region and the time period you are interested in for the exposure data and I can forward to relevant people
>>
>>             I assume you want. 
>>             Pm2.5
>>             No2
...
>>             Sent from my iPhone
>>
>>             On 14 Mar 2019, at 9:05 am, Arul Earnest <arul.earnest@monash.edu> wrote:
>>
>>>             Hi Geoff,
>>>             Yes annual data would be great. There are 2 potential projects: I have asked Win Wah to look at incidence and mortality for prostate cancer in Victoria and also spoken with Farhad on colorectal cancer.. Let me know procedure to access the data...
>>>             cheers
>>>             arul
>>>
>>>             Arul Earnest (PhD, MSc, DLSHTM, BSocSc Hons) 
...
>>>
>>>
>>>             On Tue, 12 Mar 2019 at 09:47, Geoffrey Morgan <geoffrey.morgan@sydney.edu.au> wrote:
>>>
>>>                 Hi Arul
>>>
>>>                  
>>>
>>>                 Did I ever follow this up with you?  We have estimates of annual average air pollution for Victoria from satellite derived models for NO2 and PM2.5.  it is possible to get daily estimates from the monitor data for Melbourne.   let me know if you want more info
>>>
>>>                  
>>>
>>>                 Geoff
...
>>>                  
>>>
>>>                 From: Arul Earnest [mailto:arul.earnest@monash.edu]
>>>                 Sent: Friday, 17 August 2018 10:33 AM
>>>                 To: Geoffrey Morgan <geoffrey.morgan@sydney.edu.au>
>>>                 Subject: Air pollution and prostate cancer...
>>>
>>>                  
>>>
>>>                 Hi Geoff,
...
>>>
>>>                 My PhD student Win Wah has run a spatio-temporal model looking at prostate cancer incidence and socio-economic, remoteness in Victoria, etc and found some significant results...
>>>
>>>                 The manuscript is almost completed.. There was a suggestion to look at associations with air pollution. Do you know where we can get estimates (preferably at postal code level, but can superimpose at other levels as well).
>>>
>>>                 Happy to include you as a collaborator if you like. Let me know...
>>>
>>>                 cheers
>>>
>>>                 arul
...
>>>                 I acknowledge the Traditional Owners and Custodians of the lands on which I live and work and pay my respect to Elders past, present and future.
>>>
***** DONE CARDAT github click bait
***** DONE hia noise methods
***** DONE acu webinar
***** DONE car dm , give access to nico and ronngbin
***** DONE personal garden/compost/rake leaves
      SCHEDULED: <2019-03-13 Wed 10:15>
***** DONE noise postgis functions
***** DONE store the granting for noise postgis functions


GRANT EXECUTE ON FUNCTION public.cnossos_2(
    i integer,
    receptors text,
    roads text,
    landcover text,
...
GRANT EXECUTE ON FUNCTION public.cnossos_2(
    ...
    road_buf double precision,
    radius double precision,
    seg_dst integer) TO public_group;



GRANT EXECUTE ON FUNCTION public.csharp_loop_mimic() TO public;
GRANT EXECUTE ON FUNCTION public.csharp_loop_mimic() TO postgres;
GRANT EXECUTE ON FUNCTION public.csharp_loop_mimic() TO public_group;
***** DONE abn, and invoice Vic EPA and 

***** DONE supervision training


***** DONE travel and accom next week (bus)
***** DONE adam
***** DONE cares minutes josh
***** DONE follow up UCRH computer provisioning
*** 2019-04-04 Thu 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-04 Thu, hia, 50
#+end_src
***** DONE bod workflow diagram
***** DONE gasparrini read 
*** 2019-04-08 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-08 Mon, hia, 50
#+end_src
***** DONE noise old model validation words to Tim
***** DONE swarup
      SCHEDULED: <2019-04-08 Mon 11:00>
***** DONE gasparrini read 2019, 
*** 2019-04-09 Tue 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-09 Tue, hia, 50
#+end_src
***** DONE ed talk
***** DONE rod
      SCHEDULED: <2019-04-09 Tue 10:00>
***** DONE hgsg fee for nz talker
***** DONE sophie
      SCHEDULED: <2019-04-09 Tue 10:30>
***** DONE cass 
      SCHEDULED: <2019-04-09 Tue 11:00>
- act health email to swarup
...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-10 Wed, parko, 50
#+end_src
***** DONE awap bocsar  for heather 2018
***** DONE report to geoff, add to folder
***** DONE noise data with erika
***** DONE aptema parkinsons   
*** 2019-04-11 Thu 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-11 Thu, aptema, 50
#+end_src
***** DONE aptema parkinsons   
***** DONE ehi template for josh

*** 2019-04-12 Fri 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-12 Fri, hia, 50
#+end_src
***** DONE aptema parko
***** DONE ML smoke paper and appendix and data note
***** DONE tweet prep
air pollution reduction has long term benefit for greenhouse abatement and short term co-benefit on premature mortality. What's not to like about that? 
***** DONE CC in Aus data, for sui paper?
*** 2019-04-15 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-15 Mon, hia, 50
#+end_src
***** DONE barry newell
***** DONE mark enrich
***** DONE CC in Aus data
...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-16 Tue, hia, 50
#+end_src
***** DONE EH indicators meeting
***** DONE HR for sophie and christie
*** 2019-04-18 Thu 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-18 Thu, hia, 50
#+end_src
***** DONE gasparrini email
***** DONE email barry newel
***** DONE share deidentified noise with EH students

***** DONE Drought and RWS2016
***** DONE reimburse receipts
***** DONE personal email shane
***** DONE NMMAPS from gaspo
***** DONE personal email shane re built in vanities, reminder gutter are monument

***** DONE OHS training
***** DONE research data training

***** DONE noise risk map methods to Tim
***** DONE drt for 2017-2018/19
***** DONE APTEMA GEO whe exposure_new onlu 262014 not 266969?  LGA is NA?

*** 2019-04-29 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-29 Mon, hia, 50
#+end_src
***** DONE countdown aus bod 2016 and 3.5.1
*** 2019-04-30 Tue 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-04-30 Tue, hia, 50
#+end_src
***** DONE datinv postgres to sqlite for cass
    db = DAL("postgres://cassandra_yuen:MYSECRETPASSWORD@130.56.254.184:5432/data_inventory_hanigan_backup", fake_migrate_all = True)

***** DONE capstone reply camilo
***** DONE grant ardc, vic epa to guy
***** DONE meet geoff
***** DONE pm_sources fr dropnox from richared
***** DONE perth LUR
*** 2019-05-08 Wed 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-05-08 Wed, hia, 50
#+end_src
***** DONE hia enviro hia/ risk ass template as bookdown site or doc
*** 2019-05-13 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-05-13 Mon, hia, 50
#+end_src
***** DONE drt from nature
***** DONE josh 
***** DONE UC?
***** DONE meet neil
      SCHEDULED: <2019-05-08 Wed 11:30>
***** DONE meet c and c for lunch
      SCHEDULED: <2019-05-08 Wed 12:30>
*** 2019-05-15 Wed 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-05-15 Wed, hia, 50
#+end_src
***** DONE EHI air mort codes from josh to ausbod
***** DONE EHI tasklist, esp overlap with countdown
***** DONE email erika re wrd
***** DONE get ed data
***** DONE email helen re hilary
***** DONE personal jog with maeve
***** DONE countdown air
***** DONE Christine doodle
***** DONE CAR symposium rego
*** 2019-05-17 Fri 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-05-17 Fri, hia, 50
#+end_src
***** DONE try datinv EHI on swsh4
***** DONE smokeplume github with alex
***** DONE EH indicators, 
- DONE send sophie email about protocol
- DONE send noise to sophie
- DONE send reis email asking about other reports
***** DONE countdown air
***** DONE travel Barry Newell
37 parbery ave bermagui.
***** DONE long beach sunday with shane?
***** DONE arul share via farhad?
***** DONE travel CAR
*** 2019-05-21 Tue 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-05-21 Tue, HI, 50
#+end_src
***** DONE recent DPSEEA report
***** DONE EHI workflow diag
***** DONE EHindicators task list
***** DONE farhad questions
***** DONE Lidia PM2.5 and drought
***** DONE streetpro checks, upload bits
TODO this data collection contains ESRI geodatabase files, that were not copied correctly. Therefore a new migration attempt is required. Old stuff: Q:\Research\SEEF\Environment_Spatial\data\StreetPro Navigation 2012 
***** DONE WIMR google with CC
***** DONE noise meeting
*** 2019-05-23 Thu 
**** TODO-list 
***** TODO timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-05-23 Thu, ehi, 50
#+end_src
***** DONE read noise s sheet from sophie
***** DONE APMMA meeting with L Shepp
***** DONE APTEMA
- SatLUR done
- updating: Ivan found Morley papers and shared to Luke, Luke has been teaching
  + Luke from July can 
- 
***** DONE EHindicators task list
*** 2019-05-24 Fri 
...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-05-24 Fri, ehi, 50
#+end_src
***** DONE cares
***** DONE christy
***** DONE EHindicators task list and workflow
***** DONE vensim with steve
***** DONE kathleen beyer NOTES
****** ehi
******* water sources for RRv
******* 
****** NARCLIM
******* registration page and download engine?
******* GCM choice... foward on email to Matt?
GFDL-ESM2M (Dry) 
NorESM1-M (Wet) 
ACCESS1.0 consensus
...
****** SEED
****** JDAP 
****** Contaminated sites PFAS
*** 2019-05-27 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-05-27 Mon, EHI, 50
#+end_src
***** DONE doco for vensim, send to Barry
***** DONE respond to richard
***** DONE EHindicators task list and workflow
*** 2019-05-30 Thu 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-05-30 Thu, ehi, 50
#+end_src
...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-05-31 Fri, car, 50
#+end_src
***** DONE car pres LE slides
***** DONE car pres pm sources slide
***** DONE car pres cut slides (comment)
***** DONE ben model to adam via cloudstor
*** 2019-06-03 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-03 Mon, ehi, 50
#+end_src
***** DONE noise paper to coauthors
***** DONE add datinv car postgres
CREATE DATABASE data_inventory_car
  WITH ENCODING='UTF8'
       OWNER=ivan_hanigan
       CONNECTION LIMIT=-1;
pg_restore
add cass and christy
***** DONE identity
- TMBank
- tax
- unisuper
***** TODO hacky hour meeting notes
- Landing page
  + christy to join osf
  + christy to do EHI and CAR landing page
- Overview graphic
  + ivan to clean and develop as a talk
- Joy to develop dog and heatwave (with Ivan)
  + christy to review dog/heat story
- Ivan to develop the air pollution hia (with christy and josh)
- Josh to be invited to next hacky hour
  + two break out rooms, two users with data
- Planning workshops (part of new grant)

***** TODO daniel meeting notes
*** 2019-06-06 Thu 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-06 Thu, ehi, 50
#+end_src
***** DONE datinv backups swsh4 ivohano to csv (what to do now about local?)
***** DONE ehi report generator
***** DONE ehi datainv backups
***** DONE datinv car backup to csv
*** 2019-06-09 Sun 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-09 Sun, cc, 50
#+end_src
***** DONE backups
***** DONE noise draft
*** 2019-06-11 Tue 
...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-11 Tue, ehi, 50
#+end_src
***** DONE prep for meeting Tony B re vivarium, bode3
https://vivarium.readthedocs.io/en/latest/
My first impression is that it is aiming to be a large and robust python package. R packages can be large and robust too, but programmer's seem to prefer python as it is more like a software engineer's workflow (compared to a statistician or data scientist's workflow, which R is better suited to).

https://nzcms-ct-data-explorer.shinyapps.io/trimleaguetable2/
An R shiny app, designed to rank health ‘interventions’ by health gains, costs, or cost-effectiveness.
I like this interface a lot. It is a work in progress (see "Further details": Insert some text and explanation here. )
Great thing about this is the drop down list of potential interventions.
The amount of user interaction is pretty limited, but as it is build on R and shiny it is very flexible.

https://nzcms-ct-data-explorer.shinyapps.io/version8/
another shiny app, with cool graphs. The site is much more mature than above, with loads of explanatory text.

The following are all embedded in the otago site, and seem like Excel spreadsheets.

Cancer Survival
Estimated Maximum Intervention Cost (EMIC) - International version
Health System Costs
Health System Costs of Tobacco-Related Diseases 
Rapid Cost-Effectiveness Calculator (Version 1)
Rapid Cost-Effectiveness Calculator (Version 2)
***** DONE store submitted work to owncloud
***** DONE thurs appointments
- Done Tony C
- DONE Kathleen
- DONE Daniel 
- DONE Luke
- DONE Hoang
***** DONE submit noise paper
*** 2019-06-12 Wed 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-12 Wed, ehi, 50
#+end_src
***** DONE send noise paper to coauth
***** DONE HR pay
***** DONE HGSG finance stuff
***** DONE casanz bismithe speaker details
Ivan completed his undergraduate studies in the Human Ecology program at ANU and his PhD in environmental epidemiology at the National Centre for Epidemiology and Pop Health (NCEPH, ANU) where he was also the Centre's data manager and data analyst. From 2001 to 2013 Ivan worked closely with Prof Tony McMichael's Climate Change and Health program at ANU. In 2014/15 he led the development of the data portal for Prof David Lindenmayer’s Long Term Ecological Research Network. Ivan is a data scientist whose research seeks to disentangle health effects of environmental changes from social factors.

Ivan worked for Charles Darwin University in 2007 on an ARC-linkage project studying the impact of bushfire smoke on human health, and following that worked 2009-2011 for the University of Tasmania led biomass smoke and human health project. After completing his PhD in 2016 Ivan moved to the University of Sydney School of Public Health and received a post-doctoral scholarship from the Centre for Air quality, energy & health Research (CAR) at the multidisciplinary Woolcock Institute of Medical Research where he  continued studying human exposure to smoke pollution from landscape fires, among other things. Ivan is now half time employed by CAR as the Centre's Data Scientist, and half time as research fellow working on a range of environmental health projects.
***** DONE respond lee taylor re time series episig
***** DONE prep meet joel
Geoffrey Morgan
	
Jun 5, 2019, 10:41 AM (7 days ago)
	
to Ivan, Edward

Ed/ Ivan

this is a great opportunity to talk to joel about your plans for the SPH re: research and teaching.  I suggest preparing a very brief summary (1 sentence each activity, including funding source – if any- and duration) of the projects you are currently involved with and proposed future projects including funding applications.

ivan – I think talk about the funding for you salary and deliverables over the past few years and the current status of next years funding for your salary, eg:

- $50k from recent CAR DAT proposal that can ideally be  used to support your salary (in one form or another) next year. 
- remainder of funding hopefully to come from: APMMA? CAR Data scientist?
- GM/IH continuing to look for project funding
- teaching????

One consideration is how the SPH can benefit from CAR DAT in terms of a data source for student projects.  if we could link CAR DAT with access to health data we could develop a steady stream of projects for students.   this could compliment the env epi teaching unit being led by Ed. 

We have developed a (informal?) group of people with quantitative env ep experience, ie: Ed, Ivan, Mona, Josh, Darren, Jeff Standen, me….   we are linking with Melody and Adrian re: PA.  we are linking with Tony re; Planetary health and the HHSI node  We have a small LCA project with Arunima/ Manfred.   Perhaps we need to be a bit more strategic about the focus of our work over the next few years……….
...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-13 Thu, ehi, 50
#+end_src
***** DONE EHI sophie summaries EWE and meet
***** DONE donna green draft
- Section 3
  + "Respiratory diseases, obesity and diabetes are increasingly important causes of ill-health for Australian children.": over the life course 
  + "REF with $$ HERE": you could use DALYs instead of $$
  + "Unless unchecked" = If left unchecked

***** DONE summary AIHW BoD, GBD etc
The Australian Institute of Health and Welfare (AIHW) has estimated that the burden of all disease and injury
attributable to air pollution was 0.6% in Australians in 2011, and accounts for 1.3% of the total fatal burden
(Australian Institute of Health and Welfare 2016, p. 193). Around 6% of the total burden of coronary heart disease
was attributed to air pollution, and 5% of the stroke burden. Respiratory illness such as lung cancer and chronic
obstructive pulmonary disorder (COPD) had contributions from air pollution of 0.7% and 0.3% respectively.
Furthermore, the Global Burden of Disease (GBD) study estimated that in 2012, the fraction of Disability Adjusted
Life Years (DALYs) attributable to ambient air pollution ranges from 8% for COPD to 25% for lung cancers (World
Health Organization, 2016). The GBD also estimated that, in 2010, exposure to ambient air pollution was the ninth
most important risk factor for burden of disease globally (Lim, et al. 2012).
In addition to air pollution, the impact of social disadvantage has contributed to an alarming rise in non-
communicable diseases in Australia and can influence air pollution exposures and impacts. Social disadvantage risks
manifest themselves as poor education, low incomes, poor housing and diet, often compounded by time-scarcity
leading sometimes to low physical activity. Each of these risks has impacts on cardiorespiratory diseases. The
Australian profile derived from the GBD 2015 has demonstrated unequivocally the dominance of non-communicable
diseases in the burden of overall disease in Australia (Institute of Health Metrics and Evaluation 2015).

Refs:
Australian Institute of Health and Welfare. (2016). Australian Burden of Disease Study: Impact and Causes of Illness and Death in Australia
2011. Australian Burden of Disease Study Series No. 3. BOD 4. AIHW, Canberra.

World Health Organization. (2016). Ambient Air Pollution: A global assessment of exposure and burden of disease. World Health

Lim, S. S., Vos, T., Flaxman, A. D., et al. (2012). A comparative risk assessment of burden of disease and injury attributable to 67 risk
factors and risk factor clusters in 21 regions, 1990-2010: A systematic analysis for the Global Burden of Disease Study 2010. The Lancet,
380(9859), 2224–2260.

Institute of Health Metrics and Evaluation. (2015). GBD Profile: Australia 2015. IHME, Washington, USA. Retrieved from
http://www.healthdata.org/results/country-profiles (accessed 15th March 2017)
***** DONE exposim with luke
*** 2019-06-14 Fri 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-14 Fri, ehi, 50
#+end_src
***** DONE reimb syd sup train so far
***** DONE supervisor training
- Director HDR program
- INDUSTRY: is defined as the end user of research, can include
  government, BHP, coles, even the library (where they are not doing
  research themselves, they provide service based on research)
- Yammer updates, formal route is associate dean
- associate dean research and education (not dean research), has to provide advice on
  quality of candidates (regarding likely to win a scholarship)
  + AssocDean R+E: Victoria Koger Med and Health Sci
  + Uni Quality Index, is disappearing, but is available to academics (not for students)
***** DONE hr cassandra 1.6 days per week
23 hours
...
#+RESULTS:
: 1.64285714285714
***** DONE travel request melbourne
***** DONE noise with adam, work out steps
- ivan upload to postgis,
- create cloudstor share
- start with buildings
***** DONE ISEE rego
Fri 14/06/2019 10:19
Ivan

 

thanks for splitting this.  lets see how things work out with budget and I’ll cover more if I can, or we can potentially cover from CAUL but will need to check with Jane when she is back

 

please use: K5902 V0018 for now
***** DONE reimburse usyd super training
***** DONE water borne flow chart
*** 2019-06-17 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-17 Mon, ehi, 50
#+end_src
***** DONE rachel and erika
***** DONE SEED donna
***** DONE buildings for adam
*** 2019-06-18 Tue 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-18 Tue, ehi, 50
#+end_src
***** DONE travel to melb
***** DONE bismithe presentation
***** DONE kathleen meeting
JDAP = vegetation
SEED = natural and land cover
CLIMATE PORTAL = 
***** DONE landuse with erika
***** DONE water bodies for josh
***** DONE plan biosmoke talk
***** DONE travel invoice aimmee
***** DONE street pro for adam
***** DONE landuse for adam
***** DONE travel receipts melb casanz
***** DONE ML paper meet martin
***** DONE meeting with kathleen
      SCHEDULED: <2019-06-21 Fri 13:00>
***** DONE travel chang codes on casanz? or when doing expense allocation?
*** 2019-06-22 Sat 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-22 Sat, hia, 50
#+end_src
*** 2019-06-24 Mon 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-24 Mon, ehi, 50
#+end_src
***** DONE arcgis with ucrh pc, test connect
***** DONE stefan reis visit to Jal
***** DONE EHI meeting
      SCHEDULED: <2019-06-24 Mon 13:00>
***** DONE groups io/c5
Dear Climate Change Connected Colleagues Club (C5),
I have set up a new email list based on the old ANU group called "C5" started by Prof Tony McMichael over 10 years ago, and have added a few new emails.
If this is NOT of interest to you please decline the offer to join the group list.
For those happy to join just accept this invitation, then you can send and receive emails to c5@groups.io

For those of you in Canberra, our C5 colleague Prof Colin Butler will be in town next week 1st-5th July and I think a great opportunity for informal socialising.
Day/time to be confirmed. We will meet at the ANU Uni House Fellows Garden Cafe (https://goo.gl/maps/2kvNUqKreqv363Er6).

Send me an email at ivan.hanigan@gmail.com if you would like to come, and I will firm up a time with Colin and let you know.
...
Edward Ford Building, Fisher Road, Camperdown, Sydney. NSW, 2006
and
Centre for Air pollution, energy and health Research (CAR)
Woolcock Institute of Medical Research 
***** DONE pick up maeve
      SCHEDULED: <2019-06-24 Mon 15:00>
*** 2019-06-26 Wed 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-26 Wed, ehi, 50
#+end_src
***** DONE geoscape contract 
***** DONE scirep review

Review Manuscript Instructions
Reviewing the Manuscript

To continue to the online review form click the button “Submit Review” at the end of this page. The next screen is broken down as follows:

    Nine statements about the manuscript for which you must select the most appropriate response (Yes/No/Not Applicable)
    Remarks on the technical assessment
    Remarks to the editorial board member
    Remarks to the author

Your review will not be submitted until you have clicked "Submit Recommendation" on the next page.
...
You can get the status of your assigned manuscript(s) by:
...
***** DONE biomass paper review
***** DONE pick maeve
      SCHEDULED: <2019-06-26 Wed 15:00>
***** DONE joy
****** DONE stefan budget
500-600 flights
200-250 accom
...
numbers
style of meeting
1. training with charging entry?
2. expert presentation and then our researchers / ECR / postdoc for feedback
3. expert pres, high level pres our group/other group(CAUL, UQ Nicholas Osborne) /  final session on funding (UK-Australia plans for the ‘Fund for International Collaboration’ bilateral funding theme)

Idea to go 9-3pm?
Presentations from Ivan on CARDAT
CAUL?? Maybe not for close contact funding options

****** DONE dogs =  friday after cares
*** 2019-06-27 Thu 
**** TODO-list 
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-27 Thu, ehi, 50
#+end_src
***** DONE travel request syd episig, put on cv
***** DONE EHI landing page
***** DONE stefan budget
***** DONE daniel register,
***** DONE adam jamming
*** 2019-06-28 Fri 
**** TODO-list 
***** DONE timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-06-28 Fri, cares, 50
#+end_src
***** DONE Cares
****** DONE agenda 
****** DONE check workplan
****** DONE check geoff additions
****** DONE cardat overview as slides
****** DONE generate data inv and upload
****** DONE tony blakely meeting
****** DONE stefan R
****** DONE dyson meeting
****** DONE hacky hour
****** DONE UC A-GeoHL
***** DONE call brett
- power in stair well side near the door
- remove pendnt light from nea bedroom
- gas heater ready to go
- dimmer in master bedroom
- chat about walk in robe power point (probably move but don't)
- can we get a copy of the drawing he made
***** DONE cares meet
***** DONE meet joy
*** 2019-06-30 Sun 
**** TODO-list 
...
***** timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-07-02 Tue, ehi, 50
#+end_src
***** DONE grants / ardc thoughts with Geoff, send contract to alex
- woolcock is a fight (guy current)
- ucrh is better than sph, feel it out with alex
- see if ARDC will put in to contract
- want to use for my salary (mostly) and ask to defer car payemnets
  + talk to guy re this
  + also about funding next year

***** DONE shopping
****** DONE universal remote jaycar
****** DONE inline skate wheels
****** DONE officeworks: printer, paper,
****** DONE guitar stuff
***** DONE CC sui draft
***** DONE EHI data requests (ben, ), 
***** DONE cc sui hia map
***** DONE EHI data requests darren 
***** DONE gasparrini job
***** DONE groups.io / cardat/c5
***** DONE EHI meeting 11am
      SCHEDULED: <2019-07-02 Tue 11:00>
***** DONE narclim WTF
***** DONE ucrh new computer, 
***** DONE car data team meeting 13.30
*** 2019-07-03 Wed 
***** TODO timesheet
#+begin_src txt :tangle work-log.csv :eval no :padline no
2019-07-03 Wed, ehi, 50
#+end_src
***** DONE geoscape order
...
To: Ivan Hanigan
Subject: RE: Showcase of noise project for PSMA
 
I can give you the cost code and trish (or someone in finance) can arrange the payment/ invoice.  I suggest you email trish (ucrh finance) with the details asap and she how she want to manage it.  they may need to prepare an invoice.  let me know the total cost once that is finalised and we can proceed, but get the payment details to trish asap so she can advise.  it can take longer as the financial year approaches as there is a lot of other finance work on
...
From: Ivan Hanigan 
Sent: Friday, 14 June 2019 5:40 PM
To: Geoffrey Morgan <geoffrey.morgan@sydney.edu.au>
Subject: Re: Showcase of noise project for PSMA

 

will you be able to sign from Seoul?
...
++ [data science intersects a science discipline with data hacking and maths/stats http://drewconway.com/zia/2013/3/26/the-data-science-venn-diagram]

From: Geoffrey Morgan
Sent: 14 June 2019 17:07
To: Ivan Hanigan
Subject: FW: Showcase of noise project for PSMA
...
I’m happy for you to make the decision on this, or advise of the options.  we can use CAUL funds to cover this.

 

g
***** DONE capstone marking (due 26th)
***** DONE previous notes from meetings with christy
****** DONE surface water
****** DONE zenith for adam
****** DONE report production
******* DONE 1:5:25 report style
****** DONE google group for a) CARDAT, b) C5
****** DONE ivan to create github
****** DONE Ivan to read one pager (add / modify graphic)
****** DONE ivan to read user guide
****** DONE email countdown indicator 3.5.3
***** DONE narclim WTF
***** DONE notes from meetings with christy
****** DONE landing page with ivan / workflow, CAR overview, slideshow etc
****** DONE data sharing with a) owner and b) requestor
***** TODO EHI read sophie work
***** TODO sydney time series slides
***** TODO notes from meetings with christy
****** TODO landuse NSW
****** TODO council_rms for adam
****** TODO data report for christy
- HIEMSTRA
- AURIN
- EPA doc
  + EH tracking
...
****** TODO ardc grant
****** TODO procedures manual draft (in EHI folder)
****** TODO marge
******* newsletter
******* landing page
******* m&e
***** TODO geoscape and owncloud, external HDD
***** TODO Daniel surkalim data requests Darren
****** TODO walkability for daniel 
***** TODO geoff confidential report WHO
***** TODO UCRH admin concur delegate
Holly Jenkins <holly.jenkins@sydney.edu.au>
	
Fri, Jun 28, 3:08 PM (4 days ago)
	
to Frances, Suzanne, Linda, Jonathan, Robyn, Trisha, Tracey, Judy, Margaret, Farhad, James, Jo, Ivan, Joshua, Amanda, Sarah, Geoffrey, David, Alex, Jennifer, Rita
Hi,
Would you please be able to give me delegation to your concur account? I am going to start helping with acquitting credit cards 
To do this you will need to:

    sign in
    click profile
    go to profile settings
    on the very left of the page under expense setting click expense delegates
    click add
    type my name into the box that drops down
    click add
    tick the boxes that say; can prepare, can submit claims, can submit requests, can view receipts and receives emails
    ensure the boxes that say; can use reporting, can approve, can approve temporary, can preview for approver and receives approval emails all remain unticked
    click save
***** TODO cowie european protocol
***** TODO email stefan R about the talk
***** TODO ardc and salary
***** TODO Vic EPA description to Tim, Ed, Next Gen to Barry?
***** TODO grants /  partnership with RSO
***** TODO meeting notes from luke
***** TODO request travel ISEE
***** TODO ML fig1 asap revise and do different OD thresholds
***** TODO bld zone geoscp add for adam?
***** TODO drought for kimberly
***** TODO summary tony blakely for geoff/guy/joy
***** TODO joy invitations etc
***** TODO reimb outstanding expenses
***** TODO contact usyd energy lawyer about nepm summary
***** TODO smoke ml with hoang 1) big zone, 2) pure R
***** TODO usyd IT use usyd wifi not eduroam
***** TODO usyd IT remote desktop, and new PC
***** TODO get geoff who eh ind rep conf
***** TODO Cassandra publid data bash script
***** TODO send vanessa j DMP 
***** TODO flow chart spatial frame ordering in slides
***** TODO aparna paper
***** TODO kimberley drought data
***** TODO exposim with luke THE PLAN 
/home/ivan_hanigan/Dropbox/projects/air_pollution_ucrh/CARET/Exposure_simulation_study/CARET_exposure_simulation_study_shared/manuscript/appendix/04_from_luke

replace shuvo with lianne 

0 skeleton of discussion send to Luke, Gavin

1 send all CAR not Guy

2 lianne howard guy

journals
- envi mod soft
- spatial and spatiotemporal epi
- computer and urban enviro
- aust geog
***** TODO EHI summaries others
***** TODO arrange melbourne
- DONE speaker details
- keith ardc tues? 
- pres wed + workshop and meet vic epa?
- Thurs meetings?
***** TODO EPA actions auto pay
***** TODO EHindicators read lit summaries, task list and workflow, sync to hia workflow and pres
***** TODO review a paper
Reviewing the Manuscript
To continue to the online review form click the button “Submit Review” at the end of this page. The next screen is broken down as follows:
...
Clicking on the "Check Status" link at the bottom of the displayed page.
This procedure will display detailed tracking information about where the manuscript is in the submission/peer-review process.
***** TODO ardc social to mark
***** TODO ardc workshop to barry
***** TODO sysdyn to all coauth
***** TODO summary blakely
***** TODO ISEE budget
***** TODO check the old TODOlist XLS against database, check the s'sheet we sent to kathleen
***** TODO how2readnwrite cc sui
***** TODO ehi buffer zones
***** TODO bme old results in dropbox
/home/ivan_hanigan/projects/Neighbourhood_Exposures/AirPollutionNeighbourhoodExposures/working
what about 437? this is 438

/home/ivan_hanigan/Dropbox/projects_environment_general_transfers/Neighbourhood_Exposures/AirPollutionNeighbourhoodExposures/working/437

***** TODO nt air poll publish, tell cass
***** TODO streetpro to adam via cloudstor
***** TODO geoff todo list
- ISEE budget to geoff, recoup rego for Aimmee
- Travel wed 12th - Friday 14th
- Travel week after to Melb

- DONE Donna Green
- DONE Blakely
- DONE Joel Negin and Janelle
- DONE contact Alex Grantham re grant RSO USyd or Woolcock. 

***** TODO find ben noise buildings example for upload postgres
***** TODO Streepro check for road corridors, upload to postgres
***** TODO sydney GCC exp and health and pop to run the simulation in Vensim
***** TODO Martin apply for national PM2.5 (Darwin) from Luke
***** TODO vuln ref
It was in chapter 2 of the below. See page 71, second column, 
...
FROM 
Cardona, O.D., M.K. van Aalst, J. Birkmann, M. Fordham, G. McGregor, R. Perez, R.S. Pulwarty, E.L.F. Schipper, and B.T. Sinh,
2012: Determinants of risk: exposure and vulnerability. In: Managing the Risks of Extreme Events and Disasters to Advance
...
***** TODO heat ref to file
Guo Y, Li S, Liu DL, et al. Projecting future temperature-related mortality in
three largest Australian cities. Environ Pollut 2016; 208: 66-73.
***** TODO find parallel kriging from Josh is it in air assess?
***** TODO EHI emissions from richard (and the whole shebang)
***** TODO hia enviro hia/ risk ass template
***** TODO ml smoke ahi readme cloudstor published, backup canberra codes to sydney cloudstor 
***** TODO conferences
- ISEE
- CAR
- Modsim

***** TODO ml smoke appendix dl link from csiro (is it going to be there in future?)
download data from https://hpc.csiro.au/users/254864/ML_smoke/

***** TODO aus bod pm2.5, iomlifetr, aging chain
***** TODO zenith data, follow up with Steven
***** TODO geoscape doco, follow up for noise
***** TODO noise with Adam
***** TODO ABS 2006 BCP (and 2001)
***** TODO NHMRC, Vic EPA one pager to Tim and Guru
***** TODO RWS drought
***** TODO aptema drought
***** TODO hia compare melb pm25 to ausbodpm25 codes
***** TODO hia convert ausbodpm25 to nswpm25 shared on coesra private with ivan@sydney
***** TODO hia iomlifetR disentangle, where is orig spreadsheet? consider convert to deSolve system dynamics model
***** TODO hia general lifetables, see hia tools org todo-list
***** TODO sysdyn duggan book (note where the codes are into overview.org)
***** TODO drt rws2016
***** TODO EH indicators methods to Reis?
***** TODO UCRH for new laptop screen
***** TODO backups final works
****** DONE sync onto UCRH? Probably not, ratioalise the 600MB of noise temporary first
****** TODO move stuff from cloudstor canberra to usyd
******* already moved free parking BCP40.R, but that needs to be saved somewhere (APTEMA???)
******* DONE hia / noise
****** TODO delete owncloud_canberra from coesra @ canberra
****** TODO delete owncould_canbbera from cloudstor @ canberra
***** TODO noise model postgis and data from morley
***** TODO noise model erika heights
***** TODO HR system Tony to adviser
***** TODO refs re indicators/measures/metrics
...
https://it.toolbox.com/blogs/slymshaky/measures-metrics-and-indicators-040408
***** TODO other links
hernan data sci
https://arxiv.org/abs/1804.10846
hoax
https://youtu.be/X34tNT_rF6Q

Bushfire
https://publications.csiro.au/rpr/download?pid=csiro:EP129645&dsid=DS2

https://mobile.abc.net.au/news/2018-12-27/bushfire-history-australia-data-saving-lives/10606144

Lü, J.; Liang, L.; Feng, Y.; Li, R.; Liu, Y. Air Pollution Exposure and Physical Activity in China: Current Knowledge, Public Health Implications, and Future Research Needs. Int. J. Environ. Res. Public Health 2015, 12, 14887-14897. doi: 10.3390/ijerph121114887

Lopez, D.H.; Rabbani, M.R.; Crosbie, E.; Raman, A.; Arellano, A.F.; Sorooshian, A. Frequency and Character of Extreme Aerosol Events in the Southwestern United States: A Case Study Analysis in Arizona. Atmosphere 2016, 7, 1. doi: 10.3390/atmos7010001

http://www.ventanasystems.co.uk/forum/viewtopic.php?t=1439
https://stackoverflow.com/questions/24361146/pass-variables-and-names-to-data-table-function

r - pass variables and names to data.table function - Stack Overflow
I have a report that needs to be applied for different names of data.tables [both j and by]. The only way I get it done it by wrapping the arguments in an eval ...
stackoverflow.com

https://stackoverflow.com/questions/12603890/pass-column-name-in-data-table-using-variable


https://www.dynamo-hia.eu/en/documents-and-publications
***** TODO HIA overviews
- RR / PAF, applied to observed all cases in total population
  + e.g. all-cause death count per SA2 (linear)
  + e.g. distance to swamp and RRv (non-linear)
- RR / PAF applied to expected cases in population subgroups
  + e.g. age-specific all-cause death from STE downscaled to SA1
- attributable risk at very small scale
  + e.g. cause-specific IHD deaths from LGA downscaled to MB
***** TODO qc_western_syd_aptema
from coesra canberra
sa3_fname <- "/home/public_share_data/ResearchData_CAR/Environment_General/ABS_data/ABS_Census_2016/abs_sa3_2016_data_provided/SA3_2016_AUST.shp"
sa3 <- readOGR(sa3fname)
sa3 <- readOGR(sa3_fname)
library(rgdal)
sa3V2 <- sa3[sa3@data$STE_CODE16 == 2,]
plot(sa3V2)
sa3V2 <- sa3[sa3@data$STE_CODE16 == 1,]
plot(sa3V2)
plot(sa3V2, xlim = c(100))
plot(sa3V2)
axis(1); axis(2)
plot(sa3V2, xlim = c(145,151))
plot(sa3V2, xlim = c(145,151))
axis(1); axis(2)

plot(sa3V2, xlim = c(150,152), ylim = c(-34.5, -32.3))
plot(sa3V2[sa3V2@data$SA3_CODE16 %in% c(12701:12703, 12301:12304, 12401:12405,11503),], add = T, col = 'red')
library(maps)
map.scale(ratio=F, x = 152, y = -34.2)
box()

***** TODO aptema drt
****** TODO k10/pm/drt
***** TODO symposia 1) AIRCAP, 2) blending with Reis
***** TODO swishia blog and R package swishia (book can be HIA methods with R)
***** TODO ivan blog is things like community service re maps: map.scale, where to put the misclass methodology bit?
***** TODO car dat blog (based on discussion with swishia)
***** TODO C5V2 emails are in dropbox, add fay's group, create google group
***** TODO APTEMA SEEF mobility and matching PPNs
***** TODO aptema west syd map code is on coesra desktop
***** TODO aptema mort save analytical_environment to RData (and does it make diff using 1.88?)
***** TODO aptema dt in func
***** TODO hia buy sysdyn ebook, send comment to josh, richard and geoff
***** TODO ivan@sydney versions/ownCloud_backup need to be removed
***** TODO get guru jazzamatazz
***** TODO datinv keep adding
****** TODO add ndvi
****** TODO add geoscape
****** TODO add awap
****** TODO add ILOCs
****** TODO add keywords to meshblocks
****** TODO add ozone kriging to oeh project (and datasciencetrain)
****** TODO add canberra hospital rates (and datasciencetrain)
***** TODO awap poa11
***** TODO awap check 2018, finish with heather  
***** TODO decommission rstudio.coesra.org (backups are current?)
***** TODO ehi notes from meeting, confer with kathleen, send to partners, send methods to tony C?
***** TODO swish sharing description
****** open to world: github, osf
****** open to big group: car group on coesra with cloudstor sync, and osf?
****** open to medium group: vicepa on coesra, no cloudstor sync, manually to ivan@syd cloudstor/shared
****** mediated: DM to individula car on cloudstor 
****** private small group: HHSI node on coesra, no cloudstor sync
****** private individual: ivan@canberra on coesra with cloudstor sync
***** TODO EH indicators with WRD / Streetpro (via UCRH RDP)
***** TODO EH indicators methods loose ends
****** TODO paper by mark, store megaphone controlled vocab
****** TODO EHindicators send new yorker pdf and better thoughts
***** TODO aptema mort etc next steps
****** TODO mort refs with josh (mendeley?)
****** TODO one pager for NO2 gnaf LUR (where we got to and next steps)
****** TODO drought one pager > APMMA
****** TODO send cause specific summary to Farhad
****** TODO APMMA exposure bayesian summary, can I use it?
****** TODO why seeflinkage workspace has blgeo in the air pollution folder?
****** TODO partialling out the SEIFA health bit
***** TODO EHindic get indicators data audit going (cassandra data audit?)
**** TODO-list 
***** TODO 
**** TODO-list 
***** TODO car f2f
**** TODO-later
***** DONE get paper on indicators from marks team
***** DONE ehi progress report january plan due to geoff 
****** TODO print rapid review paper
****** TODO incorporate the IUCN framework
****** TODO print Benjamin's papers
***** TODO data audit plan and new datasets to add
****** TODO Lidia/DMS/Bryce/API
****** TODO IMHE/GBD
****** TODO China
****** TODO Brauer
****** TODO AHI/AOD
****** TODO data audit describe pm2.5 adjustment
****** TODO data audit caret / cares data/project spreadsheet
...
****** TODO what is dropbox tapm syd 2005? from who?
***** TODO exposim_synthetic_cohort_NSW western sydney and simpop for case studies (see simpop folder and shared with Christine) +pM25
***** TODO jadehawk backups prior to updates continued
****** TODO on coesra@sydney try to restore small postgis_hanigan on that machine?
****** TODO then restore to jadehawk postgis_han 2nd time do biggest from hack? this tests old version of postgis/ubu
****** TODO sync dropbox then pause again
****** TODO do another daily.sh
****** TODO do upgrade?
****** TODO rename postgis_hanigan_backup folder on PC to postgres_backups
****** TODO if postgres is OK then get all hack databases backed up
****** TODO upgrade hackintosh (if possible)
****** TODO music sync from itunes to HDD with new stuff
***** TODO for enrich
****** TODO data 1) ehfload and 2) mortality by fixed community/ILOC match
****** TODO refs
...
****** TODO enrich comm -> ILOC  and SA1 -> ILOC then get mort -> ILOC and take away (not unit recs)
***** TODO overleaf Vs Rmarkdown and OSF
***** TODO CONSULTANCY $ data FOR NOVEMBER AND OCTOBER
> 24300-23945
[1] 355
> 62.7-6.27
[1] 56.43
...
[1] 23945.17
> 
***** DONE michelle stuart byron visit
***** TODO aptema protocol 1) notes re mortality paper 2) cause specific analysis notes
***** TODO plan for pm2.5 and no2
****** TODO spatiotempo leads into pm2.5 for walkairhealth
...
****** TODO plan for letter re population exposure
***** TODO vetcompass data
***** TODO funding nhmrc partnerships planning WHEN IS IT DUE
***** TODO funding $grant 1) Participatory HIA toward 2) ecosocial observatory
- name for CAR bit of CoESRA-CAR? SWISH?
***** TODO funding: eco-social observatory
****** TODO usyd alison birt get Ivo a key
****** TODO usyd research office contact re vic epa bid
****** TODO usyd travel to meet early feb
****** TODO vicepa one pager by feb (what date)
***** TODO funding plan grant partnership linkage: notes re stakeholders 

From: Margery Overs 
Sent: Thursday, December 06, 2018 10:20 AM
To: Geoffrey Morgan <geoffrey.morgan@sydney.edu.au>
Cc: Joy Tripovich <joy.tripovich@sydney.edu.au>
Subject: FW: Software Tool to estimate the health impacts of air pollution, including smoke episodes
...
Joy let me know about your conversation yesterday about the meeting on 17 December about developing a software tool for estimating and visualising the health impacts of air pollution. I think she also mentioned that it covers similar ground to a request that came out of the stakeholder roadshows - for an online tool that ‘measures exposure estimates at the 200nm level for Australian capital cities and information about likely health impacts’.

 

We’ve been looking at how to progress this idea both with researchers (you and Ivan) and the stakeholders, and had thought a meeting at some point to bring researchers and the stakeholders together would help to nut out the research question.

 

We wondered whether the meeting on 17 December might be an appropriate forum for that. I’m still getting my head around the issues so perhaps they are two very different tools. But if they are similar, would it be ok to invite the key stakeholders at the roadshow who called for the tool? They are listed below – three are from Sydney so could attend in person.  No problem if that wouldn’t work – but either way Joy and I would like to talk to you and Ivan about this project and next steps, eg how it relates to COESRA.

 

Stakeholders interested in online tool:

Kendall Banfield (Inner West Council)
City of Sydney Council (Jess Miller- note now resigned but still in council)
Ingo Koernicke (Sutherland Council)
Peter Taylor (WA DWER)
Pierina Otness (WA DWER)
 

Please let me know what you think. Happy to discuss on the phone.
...
Marge
***** TODO ucanberra move data from cloudstor to usyd cloudstor
****** TODO backups re 1) coesra and 2) UC
***** TODO noise stuff to tim
***** TODO ucrh q drive access
***** TODO coesra long time future plan, make for cares agenda
***** TODO cares/caret email re data audit and accessibility
***** TODO barry newell 1) read 2) invite car mentor
...
***** DONE to meet cassandra
***** TODO to meet richard
***** DONE bookdown to farhad
...
***** DONE datainv add pm25 monitor data (vic only) and to web2py and run bookdown?
***** TODO cloudstor checks of exposim download to lismore for lucas
***** TODO Q/EnvGen question to rod and backups with Geoff
***** DONE AusBOD-pm25 notes for main mja all aus paper and VicEPA air deliverable
...
****** TODO SURE audit dir()
****** DONE aptema meet farhad and margaret re structures 
****** DONE notes re aptema protocol meet with farhad
...
***** DONE josh kriging, coesra
***** TODO uc cc report w jacki
***** DONE countdown para/paper/data
***** TODO richard coesra 
***** DONE biosmoke paper resubmit
***** TODO biosmokedb add dates
****** TODO Vic biomass valid db enter from gov report
...
****** TODO ML smoke case studies NT, TAS
***** TODO data/filing
- awap
- study regions
...
***** TODO SURE seifa 06/11, disability index partialled out
***** DONE SURE numbers in liverpool
***** DONE reminder about roel and bert and blend workshop invitees get a summary
- the priorities list
- the videos
...
***** DONE data sharing for coesra
****** global pm2.5
****** study regions western sydney
****** abs census 2016

***** DONE jfsp AHI for a time NT, tas, syd
...
***** TODO meet gavin buzzo re mental health?
